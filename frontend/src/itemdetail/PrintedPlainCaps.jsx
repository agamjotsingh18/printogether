...
import capImg from "../assets/cap.png"; // Main image
import capImg2 from "../assets/cap.png"; // Extra image 1
import capImg3 from "../assets/cap.png"; // Extra image 2
import capImg4 from "../assets/cap.png"; // Extra image 3
import capImg5 from "../assets/cap.png"; // Extra image 4
...
const PrintedPlainCaps = ({ addToCart }) => {
  ...
  const [mainImage, setMainImage] = useState(capImg); // State for main image
  ...
  const capDetails = {
    ...
    image: capImg,
    description:
      "High-quality custom printed plain caps for all your fashion and branding needs. Perfect for personal use, events, and promotional purposes.",
    features: [
    ...
    extraImages: [capImg2, capImg3, capImg4, capImg5], // Extra images
  };
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            >
              {capDetails.extraImages.map((image, index) => (
                <Paper
                  key={index}
        ...
        <Grid item xs={12} md={6}>
          ...
          <ul style={{ marginLeft: "20px", marginBottom: "20px" }}>
            {capDetails.features.map((feature, index) => (
              <li key={index}>
          ...
          >
            {capDetails.materials.map((material, index) => (
              <Paper
                key={index}
