...
import a5FlyerImg from "../assets/a5-flyer-printing.png"; // Main image
import a5FlyerImg2 from "../assets/a5-flyer-printing.png"; // Extra image 1
import a5FlyerImg3 from "../assets/a5-flyer-printing.png"; // Extra image 2
import a5FlyerImg4 from "../assets/a5-flyer-printing.png"; // Extra image 3
import a5FlyerImg5 from "../assets/a5-flyer-printing.png"; // Extra image 4
...
const A5FlyerPrinting = ({ addToCart }) => {
  ...
  const [mainImage, setMainImage] = useState(a5FlyerImg); // State for main image
  ...
  const a5FlyerDetails = {
    ...
    extraImages: [a5FlyerImg2, a5FlyerImg3, a5FlyerImg4, a5FlyerImg5], // Extra images
  };
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={6}>
          ...
          <ul style={{ marginLeft: "20px", marginBottom: "20px" }}>
            {a5FlyerDetails.features.map((feature, index) => (
              <li key={index}>
          ...
          >
            {a5FlyerDetails.materials.map((material, index) => (
              <Paper
                key={index}
...
export default A5FlyerPrinting;