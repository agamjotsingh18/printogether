...
import dlFlyerImg from "../assets/dl-flyer-printing.png"; // Main image
import dlFlyerImg2 from "../assets/dl-flyer-printing.png"; // Extra image 1
import dlFlyerImg3 from "../assets/dl-flyer-printing.png"; // Extra image 2
import dlFlyerImg4 from "../assets/dl-flyer-printing.png"; // Extra image 3
import dlFlyerImg5 from "../assets/dl-flyer-printing.png"; // Extra image 4
...
const DLFlyerPrinting = ({ addToCart }) => {
  ...
  const [mainImage, setMainImage] = useState(dlFlyerImg); // State for main image
  const [snackbarOpen, setSnackbarOpen] = useState(false); // State for Snackbar

  const dlFlyerDetails = {
    name: "DL Flyer Printing",
    image: dlFlyerImg,
    description:
      "High-quality DL flyers for all your marketing needs. Perfect for events, promotions, and branding campaigns.",
    features: [
    ...
    extraImages: [dlFlyerImg2, dlFlyerImg3, dlFlyerImg4, dlFlyerImg5], // Extra images
  };
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            >
              {dlFlyerDetails.extraImages.map((image, index) => (
                <Paper
                  key={index}
        ...
        <Grid item xs={12} md={6}>
          ...
          <ul style={{ marginLeft: "20px", marginBottom: "20px" }}>
            {dlFlyerDetails.features.map((feature, index) => (
              <li key={index}>
          ...
          >
            {dlFlyerDetails.materials.map((material, index) => (
              <Paper
                key={index}
