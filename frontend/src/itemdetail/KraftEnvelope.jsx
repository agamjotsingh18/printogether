...
import kraftEnvelopeImg from "../assets/kraft-envelope.png"; // Main image
import kraftEnvelopeImg2 from "../assets/kraft-envelope.png"; // Extra image 1
import kraftEnvelopeImg3 from "../assets/kraft-envelope.png"; // Extra image 2
import kraftEnvelopeImg4 from "../assets/kraft-envelope.png"; // Extra image 3
import kraftEnvelopeImg5 from "../assets/kraft-envelope.png"; // Extra image 4
...
const KraftEnvelope = ({ addToCart }) => {
  ...
  const [mainImage, setMainImage] = useState(kraftEnvelopeImg); // State for main image
  const [snackbarOpen, setSnackbarOpen] = useState(false); // State for Snackbar

  const kraftEnvelopeDetails = {
    name: "Kraft Envelope",
    image: kraftEnvelopeImg,
    description:
      "Our Kraft Envelopes are made from eco-friendly materials, perfect for a rustic and natural look. Ideal for invitations, packaging, and more.",
    features: [
    ...
    extraImages: [kraftEnvelopeImg2, kraftEnvelopeImg3, kraftEnvelopeImg4, kraftEnvelopeImg5], // Extra images
  };
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            >
              {kraftEnvelopeDetails.extraImages.map((image, index) => (
                <Paper
                  key={index}
