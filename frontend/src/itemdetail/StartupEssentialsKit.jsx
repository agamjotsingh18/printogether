...
import customBookmarksImg from "../assets/thank-you-card.png"; // Reusing image
...
const StartupEssentialsKit = ({ addToCart }) => {
  ...
  const kitDetails = {
    ...
    price: 1800,
    description: "Everything a growing startup needs to make a great impression, featuring practical and professional items for your team and clients.",
    items: [
      { 
            ...
            <Box sx={{
              ...
              <Stack direction="row" spacing={1} alignItems="center" justifyContent="center" mt={2}>
                ...
                <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                  Free shipping • 30-day returns • Startup-friendly packaging
                </Typography>
              </Stack>
            </Box>
          </Box>
