...
import clearStickersImg from "../assets/clear-stickers.png"; // Main image
import clearStickersImg2 from "../assets/clear-stickers.png"; // Extra image 1
import clearStickersImg3 from "../assets/clear-stickers.png"; // Extra image 2
import clearStickersImg4 from "../assets/clear-stickers.png"; // Extra image 3
import clearStickersImg5 from "../assets/clear-stickers.png"; // Extra image 4
...
const ClearStickers = ({ addToCart }) => {
  ...
  const [mainImage, setMainImage] = useState(clearStickersImg); // State for main image
  const [snackbarOpen, setSnackbarOpen] = useState(false); // State for Snackbar

  const clearStickersDetails = {
    name: "Clear Stickers",
    image: clearStickersImg,
    description:
    ...
    extraImages: [clearStickersImg2, clearStickersImg3, clearStickersImg4, clearStickersImg5], // Extra images
  };
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            >
              {clearStickersDetails.extraImages.map((image, index) => (
                <Paper
                  key={index}
        ...
        <Grid item xs={12} md={6}>
          ...
          <ul style={{ marginLeft: "20px", marginBottom: "20px" }}>
            {clearStickersDetails.features.map((feature, index) => (
              <li key={index}>
          ...
          >
            {clearStickersDetails.materials.map((material, index) => (
              <Paper
                key={index}
