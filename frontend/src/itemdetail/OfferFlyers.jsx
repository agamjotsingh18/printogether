...
import offerFlyerImg from "../assets/offer-flyer.png"; // Main image
import offerFlyerImg2 from "../assets/offer-flyer.png"; // Extra image 1
import offerFlyerImg3 from "../assets/offer-flyer.png"; // Extra image 2
import offerFlyerImg4 from "../assets/offer-flyer.png"; // Extra image 3
import offerFlyerImg5 from "../assets/offer-flyer.png"; // Extra image 4
...
const OfferFlyers = ({ addToCart }) => {
  ...
  const priceMapping = {
    "A4 (210x297 mm)": { "Glossy Paper": 50, "Matte Paper": 60, "Premium Paper": 70 },
    "A5 (148x210 mm)": { "Glossy Paper": 30, "Matte Paper": 40, "Premium Paper": 50 },
    "DL (99x210 mm)": { "Glossy Paper": 20, "Matte Paper": 25, "Premium Paper": 30 },
  };
  ...
  const [mainImage, setMainImage] = useState(offerFlyerImg); // State for main image
  const [snackbarOpen, setSnackbarOpen] = useState(false); // State for Snackbar

  const offerFlyerDetails = {
    name: "Offer Flyers",
    image: offerFlyerImg,
    description:
      "Promote your offers and discounts with our high-quality flyers. Perfect for events, promotions, and marketing campaigns.",
    features: [
    ...
    extraImages: [offerFlyerImg2, offerFlyerImg3, offerFlyerImg4, offerFlyerImg5], // Extra images
  };
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            >
              {offerFlyerDetails.extraImages.map((image, index) => (
                <Paper
                  key={index}
        ...
        <Grid item xs={12} md={6}>
          ...
          <ul style={{ marginLeft: "20px", marginBottom: "20px" }}>
            {offerFlyerDetails.features.map((feature, index) => (
              <li key={index}>
          ...
          >
            {offerFlyerDetails.sizes.map((size, index) => (
              <Paper
                key={index}
          ...
          >
            {offerFlyerDetails.materials.map((material, index) => (
              <Paper
                key={index}
