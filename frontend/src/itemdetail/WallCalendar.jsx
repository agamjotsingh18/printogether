...
import wallCalendarImg from "../assets/wall-calendar.png"; // Main image
import wallCalendarImg2 from "../assets/wall-calendar.png"; // Extra image 1
import wallCalendarImg3 from "../assets/wall-calendar.png"; // Extra image 2
import wallCalendarImg4 from "../assets/wall-calendar.png"; // Extra image 3
import wallCalendarImg5 from "../assets/wall-calendar.png"; // Extra image 4
...
const WallCalendar = ({ addToCart }) => {
  ...
  const [mainImage, setMainImage] = useState(wallCalendarImg); // State for main image
  const [snackbarOpen, setSnackbarOpen] = useState(false); // State for Snackbar

  const wallCalendarDetails = {
    name: "Wall Calendar",
    image: wallCalendarImg,
    description:
      "Stylish and functional wall calendars for organizing your year. Perfect for home, office, or gifting purposes.",
    features: [
    ...
    extraImages: [wallCalendarImg2, wallCalendarImg3, wallCalendarImg4, wallCalendarImg5], // Extra images
  };
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            >
              {wallCalendarDetails.extraImages.map((image, index) => (
                <Paper
                  key={index}
        ...
        <Grid item xs={12} md={6}>
          ...
          <ul style={{ marginLeft: "20px", marginBottom: "20px" }}>
            {wallCalendarDetails.features.map((feature, index) => (
              <li key={index}>
          ...
          >
            {wallCalendarDetails.materials.map((material, index) => (
              <Paper
                key={index}
